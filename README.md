...
- **Payments** (Sales → Payments): dashboard, a **Payment methods** tab (every provider × every channel, Add / Connect per cell), transactions, subscriptions, pay-by-link, the Providers tab with one-step Connect, and Settings.
